...
import (
	...
	"github.com/copo888/channel_app/mashangpay8888/internal/payutils"
...
func (l *ProxyPayQueryBalanceLogic) ProxyPayQueryBalance() (resp *types.ProxyPayQueryInternalBalanceResponse, err error) {
	...
	} else if balanceQueryResp.Result != true {
		logx.WithContext(l.ctx).Errorf("代付余额查询渠道返回错误: %s: %s", balanceQueryResp.Result, balanceQueryResp.ErrorMsg.Descript)
		return nil, errorx.New(responsex.CHANNEL_REPLY_ERROR, balanceQueryResp.ErrorMsg.Descript)
	}
