...
import (
	...
	"github.com/copo888/channel_app/tesihlapay/internal/payutils"
	"github.com/copo888/channel_app/tesihlapay/internal/svc"
	"github.com/copo888/channel_app/tesihlapay/internal/types"
...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	...
	channelResp := struct {
		...
		State         string `json:"trade_state"` //状态 1-成功 2-等待付款 7-关闭
	...
	} else if channelResp.Code != "00" {
		return nil, errorx.New(responsex.CHANNEL_REPLY_ERROR, channelResp.State)
	}
