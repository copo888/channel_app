...
import (
	...
	"github.com/copo888/channel_app/jisuproxypay/internal/payutils"
	"github.com/gioco-play/gozzle"
	"go.opentelemetry.io/otel/trace"
	"net/url"
	"time"

	"github.com/copo888/channel_app/jisuproxypay/internal/svc"
	"github.com/copo888/channel_app/jisuproxypay/internal/types"
...
func (l *ProxyPayQueryBalanceLogic) ProxyPayQueryBalance() (resp *types.ProxyPayQueryInternalBalanceResponse, err error) {
	...
	// 請求渠道
	logx.WithContext(l.ctx).Infof("代付余额请求地址:%s,代付余额請求參數:%#v", channel.ProxyPayQueryUrl, data)
