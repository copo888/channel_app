...
type ProxyPayCallBackRequest struct {
	...
	MerchantId      string `form:"merchantno, optional"`
	OutTradeNo      string `form:"orderno, optional"`
	PlatformOrderNo string `form:"platformorderno, optional"`
	Amount          string `form:"amount, optional"`
	Status          string `form:"status, optional"`
	Finishdate      string `form:"finishdate, optional"`
	Sign            string `form:"sign, optional"`
}

type PayCallBackRequest struct {
	MyIp        string  `form:"myIp, optional"`
	MerchId     string  `form:"p1_merchantno"`
	Amount      float64 `form:"p2_amount, optional"` // 支付金额
	OrderNo     string  `form:"p3_orderno,optional"`
	Status      int     `form:"p4_status, optional"`
	PayType     string  `form:"p5_producttype, optional"`
	RequestTime string  `form:"p6_requesttime, optional"`
	GoodTime    string  `form:"p7_goodsname, optional"`
	TradeTime   string  `form:"p8_tradetime, optional"`
	OutTradeNo  string  `form:"p9_porderno, optional"`
	Sign        string  `form:"sign, optional"`
}
