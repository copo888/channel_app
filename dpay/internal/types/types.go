...
type ProxyPayCallBackRequest struct {
	...
	CusOrderSn     string  `json:"cus_order_sn, optional"`
	OriginalAmount float64 `json:"original_amount, optional"`
	OrderAmount    float64 `json:"order_amount, optional"`
	ExchangeAmount float64 `json:"exchange_amount, optional"`
...
type PayCallBackRequest struct {
	...
	OriginalAmount float64 `json:"original_amount, optional"`
	OrderAmount    float64 `json:"order_amount, optional"`
	ReceiveAmount  float64 `json:"receive_amount, optional"`
	AttachData     string  `json:"attach_data, optional"`
	ExchangeAmount float64 `json:"exchange_amount, optional"`
}
