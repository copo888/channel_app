...
import (
	...
	"github.com/copo888/channel_app/z17pay/internal/service"
...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	data.Set("inname", req.ReceiptAccountName)
	data.Set("inbankname", req.ReceiptCardBankName)
	data.Set("inbanknum", req.ReceiptAccountNumber)
	...
	if strings.Index(channelResp.Message, "余额不足") > -1 {
		logx.WithContext(l.ctx).Errorf("代付渠提单道返回错误: %s", channelResp.Message)
