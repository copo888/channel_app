...
import (
	...
	"github.com/copo888/channel_app/vp8pay2/internal/svc"
	"github.com/copo888/channel_app/vp8pay2/internal/types"
...
func (l *ProxyPayOrderQueryLogic) ProxyPayOrderQuery(req *types.ProxyPayOrderQueryRequest) (resp *types.ProxyPayOrderQueryResponse, err error) {
	...
	if channelQueryResp.Data.State == "completed" {
		orderStatus = "20"
	} else if strings.Index("rejected,failed", channelQueryResp.Data.State) > -1 {
		orderStatus = "30"
	}
	...
	return &types.ProxyPayOrderQueryResponse{
		Status:         1,
		ChannelOrderNo: channelQueryResp.Data.TradeNo,
		//CallBackStatus: ""
