...
import (
	...
	"github.com/copo888/channel_app/z365pay/internal/payutils"
	"github.com/copo888/channel_app/z365pay/internal/service"
	...
	"github.com/copo888/channel_app/z365pay/internal/svc"
	"github.com/copo888/channel_app/z365pay/internal/types"
...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	//notifyUrl = "https://44b2-211-75-36-190.jp.ngrok.io/api/proxy-pay-call-back"

	data := url.Values{}
	data.Set("merchantCode", channel.MerId)
	data.Set("method", "C2C_DIRECT") //渠道固定只能卡卡出款
	data.Set("signType", "MD5")
	data.Set("timestamp", timestamp)
	data.Set("merchantOrderNo", req.OrderNo)
	data.Set("orderAmount", transactionAmount)
	data.Set("notifyUrl", notifyUrl)
	data.Set("accountBank", "")
	data.Set("accountBranch", req.Remark)
	data.Set("accountNo", req.ReceiptAccountNumber)
	...
	resp := &types.ProxyPayOrderResponse{
		ChannelOrderNo: channelResp.PlatformOrderNo,
		OrderStatus:    "",
	}
