...
type ProxyPayCallBackRequest struct {
	...
	MerchId string  `form:"merNo, optional"`
	OrderId string  `form:"ordernum, optional"`
	Amount  float64 `form:"amount, optional"`
	Status  int     `form:"status, optional"` //0：处理中 	1：出款成功	2：出款失敗
...
type PayCallBackRequest struct {
	...
	MerchId string  `form:"merNO, optional"`
	OrderId string  `form:"ordernum, optional"`
	Money   float64 `form:"money, optional"` //实际支付
	Amount  float64 `form:"amount, optional"`
	Status  int     `form:"status, optional"` //0：处理中	1：成功	2：超時未支付	3：失敗訂單
	Msg     string  `form:"msg, optional"`
	Sign    string  `form:"sign, optional"`
}
