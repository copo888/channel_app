...
import (
	...
	"github.com/copo888/channel_app/jianduanpay/internal/payutils"
	"github.com/copo888/channel_app/jianduanpay/internal/service"
	"github.com/copo888/channel_app/jianduanpay/internal/svc"
	"github.com/copo888/channel_app/jianduanpay/internal/types"
...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	data.Set("ordernum", req.OrderNo)
	data.Set("bankCode", req.ChannelPayType)
	data.Set("amount", req.TransactionAmount)
	data.Set("notifyurl", notifyUrl)
	//data.Set("playerName", randomID)

	// 加簽
	sign := payutils.GetSign(channel.MerId + req.OrderNo + req.TransactionAmount + channel.MerKey)
	data.Set("sign", sign)
	...
	channelResp := struct {
		...
		Bankcard string  `json:"bankcard, optional"`
		OrderNum string  `json:"ordernum, optional"`
		Amount   float64 `json:"amount, optional"`
		Img      string  `json:"img, optional"`
		PayUrl   string  `json:"payurl, optional"`
		BankUrl  string  `json:"bankurl, optional"`
		PayUrls  string  `json:"payurls, optional"`
	}{}
