...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	data.Set("bankCode", "101") //channelBankMap.MapCode)
	data.Set("bankcard", req.ReceiptAccountNumber)
	...
	// 加簽
	sign := payutils.GetSign(channel.MerId + req.OrderNo + req.ReceiptCardBankName + req.TransactionAmount + channel.MerKey)
	data.Set("sign", sign)
	...
	if strings.Index(channelResp.Msg, "大于可用余额") > -1 {
