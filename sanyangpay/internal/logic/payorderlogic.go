...
import (
	...
	"github.com/copo888/channel_app/sanyangpay/internal/payutils"
	"github.com/copo888/channel_app/sanyangpay/internal/service"
	"github.com/copo888/channel_app/sanyangpay/internal/svc"
	"github.com/copo888/channel_app/sanyangpay/internal/types"
...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	if amountFloat, err = strconv.ParseFloat(req.TransactionAmount, 64); err != nil {
		logx.WithContext(l.ctx).Errorf("请求金额转换错误:%s", req.TransactionAmount)
	}
	notifyUrl := l.svcCtx.Config.Server + "/api/pay-call-back"
	//notifyUrl := "https://3283-211-75-36-190.ngrok-free.app/api/pay-call-back"
	...
	data.Set("gateway", req.ChannelPayType)
	data.Set("amount", strconv.Itoa(int(amountFloat)))
	data.Set("callback", req.PageUrl)
