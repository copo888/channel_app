...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	...
	channelResp := struct {
		...
		Data struct {
			...
			TimeCreate string `json:"time_create, optional"`
			TimeFinish string `json:"time_finish, optional"`
			Status     int    `json:"status, optional"` //0:支付成功;1:处理中;2:支付失败
		} `json:"data, optional"`
	...
	orderAmount, errParse := strconv.ParseFloat(channelResp.Data.Realpay, 64)
	if errParse != nil {
