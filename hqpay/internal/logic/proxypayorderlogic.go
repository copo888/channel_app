...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	//notifyUrl := "http://f6a3-211-75-36-190.ngrok-free.app/api/proxy-pay-call-back"

	data := url.Values{}
	data.Set("merchant", channel.MerId)
	data.Set("requestReference", req.OrderNo)
	data.Set("merchantBank", "ICBC") //channelBankMap.MapCode
	data.Set("merchantBankCardRealname", req.ReceiptAccountName)
	data.Set("merchantBankCardAccount", req.ReceiptAccountNumber)
	data.Set("merchantBankCardProvince", req.ReceiptCardProvince)
	data.Set("merchantBankCardCity", req.ReceiptCardCity)
	data.Set("merchantBankCardBranch", req.ReceiptCardBranch)
	...
	channelResp := struct {
		...
		TradeId string `json:"data"` //渠道訂單號
	}{}
