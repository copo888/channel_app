...
type ProxyPayCallBackRequest struct {
	...
	FxId     string `form:"fxid, optional"`
	FxDdh    string `form:"fxddh, optional"`
	FxFee    string `form:"fxfee, optional"`
	FxStatus string `form:"fxstatus, optional"`
	FxTime   string `form:"fxtime, optional"`
	FxSign   string `form:"fxsign, optional"`
}
