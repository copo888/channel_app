...
import (
	...
	"github.com/copo888/channel_app/sinpay/internal/payutils"
	"github.com/copo888/channel_app/sinpay/internal/service"
	"github.com/copo888/channel_app/sinpay/internal/svc"
	"github.com/copo888/channel_app/sinpay/internal/types"
...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	if channelResp.RetCode != "SUCCESS" {
		...
		if err := utils.CreateTransactionLog(l.svcCtx.MyDB, &typesX.TransactionLogData{
			...
			TraceId:          l.traceID,
			ChannelErrorCode: channelResp.RetCode,
		}); err != nil {
			logx.WithContext(l.ctx).Errorf("写入交易日志错误:%s", err)
		}
