...
func TxPayOrderHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {

		span := trace.SpanFromContext(r.Context())
		defer span.End()

		var req types.TxPayOrderRequest
		...
		l := logic.NewTxPayOrderLogic(r.Context(), ctx)
		resp, err := l.TxPayOrder(&req)
		if err != nil {
