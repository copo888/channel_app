...
func TxProxyPayOrderQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {

		span := trace.SpanFromContext(r.Context())
		defer span.End()

		var req types.TxProxyPayOrderQueryRequest
		...
		l := logic.NewTxProxyPayOrderQueryLogic(r.Context(), ctx)
		resp, err := l.TxProxyPayOrderQuery(&req)
		if err != nil {
