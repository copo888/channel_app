...
func TxPayOrderQueryHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {

		span := trace.SpanFromContext(r.Context())
		defer span.End()

		var req types.TxPayOrderQueryRequest
		...
		l := logic.NewTxPayOrderQueryLogic(r.Context(), ctx)
		resp, err := l.TxPayOrderQuery(&req)
		if err != nil {
