...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	logx.WithContext(l.ctx).Infof("Enter ProxyPayOrder. orderNo: %s, channelName: %s, ProxyPayOrderRequest: %+v", req.OrderNo, l.svcCtx.Config.ProjectName, req)
