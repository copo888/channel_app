...
type PayCallBackRequest struct {
	...
	MerchId string `form:"app_id, optional"`
	OrderId string `form:"order_sn, optional"`
	TradeNo string `form:"yy_order_sn, optional"`
	Money   string `form:"order_amount, optional"`
	PayType string `form:"bank_code, optional"`
	Status  string `form:"pay_status, optional"`
	Sign    string `form:"signature, optional"`
}
