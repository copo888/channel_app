...
type ProxyPayCallBackRequest struct {
	...
	MerchId    string `form:"appid, optional"`
	TradeNo    string `form:"tradesno, optional"`
	Money      string `form:"amount, optional"`
	OrderId    string `form:"apporderid, optional"`
	Status     string `form:"status, optional"`
	StatusDesc string `form:"statusdesc, optional"`
