...
import (
	...
	"github.com/copo888/channel_app/globalproxypay/internal/payutils"
	"github.com/copo888/channel_app/globalproxypay/internal/service"
	"github.com/gioco-play/gozzle"
	"go.opentelemetry.io/otel/trace"
	"strconv"
	"strings"

	"github.com/copo888/channel_app/globalproxypay/internal/svc"
	"github.com/copo888/channel_app/globalproxypay/internal/types"
...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	//data.Set("total_amount", transactionAmount)
	//data.Set("callback_url", l.svcCtx.Config.Server+"/api/proxy-pay-call-back")
	//data.Set("order_id", req.OrderNo)
	//data.Set("bank", channelBankMap.MapCode)
	//data.Set("bank_card_name", req.ReceiptAccountNumber)
	//data.Set("bank_card_account", req.ReceiptAccountNumber)
	//data.Set("bank_card_remark", req.ReceiptAccountNumber)
	...
	data := struct {
		...
		BankCardAccount string `json:"bank_card_account"`
		BankCardRemark  string `json:"bank_card_remark"`
		...
		BankCardName:    req.ReceiptAccountNumber,
		BankCardAccount: req.ReceiptAccountNumber,
		BankCardRemark:  req.ReceiptAccountNumber,
	}
	...
	if strings.Index(channelResp.Msg, "Insufficient balance") > -1 {
