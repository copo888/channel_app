...
import (
	...
	"github.com/copo888/channel_app/drwaterpay/internal/payutils"
	"github.com/copo888/channel_app/drwaterpay/internal/svc"
	"github.com/copo888/channel_app/drwaterpay/internal/types"
...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	...
	channelResp := struct {
		...
		Data struct {
			...
			CustomerCallback string `json:"customer_callback"`
		} `json:"data"`
	}{}
	...
	orderAmount, errParse := strconv.ParseFloat(channelResp.Data.OrderAmount, 64)
	if errParse != nil {
		return nil, errorx.New(responsex.GENERAL_EXCEPTION, errParse.Error())
	}

	orderStatus := "0"
	if channelResp.Data.Status == 1 || channelResp.Data.Status == 2 {
		orderStatus = "1"
	}
