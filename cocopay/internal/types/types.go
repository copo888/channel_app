...
type ProxyPayCallBackRequest struct {
	...
	OrderAmount     int    `json:"orderAmount, optional"`
	PlatformOrderNo string `json:"platformOrderNo, optional"`
	ActualAmount    int    `json:"actualAmount, optional"`
	ActualFee       int    `json:"actualFee, optional"`
	OrderStatus     string `json:"orderStatus, optional"`
	SignType        string `json:"signType, optional"`
	Untitled        string `json:"untitled, optional"`
}
