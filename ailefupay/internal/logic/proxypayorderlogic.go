...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	data.Set("cType", "Payout")
	data.Set("bankCode", channelBankMap.MapCode)
	data.Set("bankBranch", req.ReceiptCardBankName)
	...
	data.Set("openProvince", req.ReceiptCardProvince)
	data.Set("openCity", req.ReceiptCardCity)
	data.Set("notifyUrl", l.svcCtx.Config.Server+"/api/proxy-pay-call-back")

	// 加簽
	source := channel.MerId + req.OrderNo + channelBankMap.MapCode + transactionAmount + channel.MerKey
