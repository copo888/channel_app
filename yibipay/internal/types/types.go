...
type Data struct {
	...
	DepositOrderId      string `json:"depositOrderId"`
	OrderPaidInAmount   int    `json:"orderPaidInAmount"`
	OrderStatus         string `json:"orderStatus"`
	RecommendDepositCny int    `json:"recommendDepositCny"`
	...
	SettlementAssetType string `json:"settlementAssetType"`
