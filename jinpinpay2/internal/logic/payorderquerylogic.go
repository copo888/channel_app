...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	...
	// 加簽
	signString := channel.MerId + req.OrderNo + "orderquery" + channel.MerKey
	...
	channelResp := struct {
		...
		OutOrder string `json:"outorder, optional"`
	...
	if err = res.DecodeJSON(&channelResp); err != nil {
		...
		if err2 := res.DecodeJSON(&channelResp2); err2 != nil {
			return nil, errorx.New(responsex.GENERAL_EXCEPTION, err2.Error())
		}else if channelResp2.Status != 1 {
