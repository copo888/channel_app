...
type ProxyPayCallBackRequest struct {
	...
	Sid        string `form:"sid, optional"`
	OutTradeNo string `form:"out_trade_no, optional"`
	Amount     string `form:"amount, optional"`
	ChargeFee  string `form:"charge_fee, optional"`
	AgencyAmt  string `form:"agencyAmt, optional"`
	Currency   string `form:"currency, optional"`
	Code       string `form:"code, optional"`
	Msg        string `form:"msg, optional"`
	Attach     string `form:"attach, optional"`
	TailNum    string `form:"tail_num, optional"`
...
type PayCallBackRequest struct {
	...
	Sid        string `form:"sid, optional"`
	OutTradeNo string `form:"out_trade_no, optional"`
	TradeNo    string `form:"trade_no, optional"`
	Amount     string `form:"amount, optional"`
