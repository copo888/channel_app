...
import (
	...
	"github.com/copo888/channel_app/fpay/internal/service"
...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	// 加簽
	sign := payutils.GetSignAES256CBC(string(out), channel.MerKey, l.svcCtx.Config.HashIv, aes.BlockSize, l.ctx)
	reqData.Data = sign
	...
	desString, errDecode := payutils.AES256Decode(channelResp.Order, channel.MerKey, l.svcCtx.Config.HashIv)
	...
	resp := &types.ProxyPayOrderResponse{
		ChannelOrderNo: desOrder.MerchantOrderNum,
		OrderStatus:    "",
	}
