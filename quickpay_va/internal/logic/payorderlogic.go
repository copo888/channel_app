...
import (
	...
	"github.com/copo888/channel_app/quickpay_va/internal/payutils"
	"github.com/copo888/channel_app/quickpay_va/internal/svc"
	"github.com/copo888/channel_app/quickpay_va/internal/types"
	"strconv"
	"time"
...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	url := fmt.Sprintf("%s/#/redirectPageVA?orderNo=%s", l.svcCtx.Config.FrontEndDomain, req.OrderNo)
