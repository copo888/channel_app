...
import (
	...
	"github.com/copo888/channel_app/sypaygcash/internal/payutils"
	"github.com/copo888/channel_app/sypaygcash/internal/service"
	...
	"github.com/copo888/channel_app/sypaygcash/internal/svc"
	"github.com/copo888/channel_app/sypaygcash/internal/types"
...
func (l *ProxyPayOrderLogic) ProxyPayOrder(req *types.ProxyPayOrderRequest) (*types.ProxyPayOrderResponse, error) {
	...
	data.Set("bank", channelBankMap.MapCode)                //PMP
	data.Set("bank_card_name", req.ReceiptAccountNumber)    //收款人姓名 請填「Gcash收款手機號」
	data.Set("bank_card_account", req.ReceiptAccountNumber) //收款人账号 請填 「Gcash收款手機號」
	...
	channelResp := struct {
		Status string `json:"status"` //取值为1 表示校验成功,其他錯誤碼 为0。
