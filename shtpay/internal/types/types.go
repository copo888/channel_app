...
type ProxyPayCallBackRequest struct {
	...
	Transferno     string `form:"transferno, optional"`
	Outtransferno  string `form:"outtransferno, optional"`
	Tradeamount    string `form:"tradeamount, optional"`
	Transferamount string `form:"transferamount, optional"`
...
type PayCallBackRequest struct {
	...
	Ramount    string `form:"ramount, optional"`
	Oamount    string `form:"oamount, optional"`
	Endtime    string `form:"endtime, optional"`
	Status     string `form:"status, optional"`
	Remark     string `form:"remark, optional"`
	Sign       string `form:"sign, optional"`
