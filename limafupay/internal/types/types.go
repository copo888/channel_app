...
type ProxyPayCallBackRequest struct {
	...
	Corderid   string `form:"corderid, optional"`
...
type PayCallBackRequest struct {
	...
	MerchantId string `form:"merchant_id, optional"`
	Porder     string `form:"porder, optional"`
	Orderid    string `form:"orderid, optional"`
	Money      string `form:"money, optional"`
	Status     string `form:"status, optional"`
	Des        string `form:"des, optional"`
	Pare       string `form:"pare, optional"`
	Sign       string `form:"sign, optional"`
	Sign2      string `form:"sign2, optional"`
	Sign3      string `form:"sign3, optional"`
}
