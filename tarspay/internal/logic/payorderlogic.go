...
import (
	...
	"github.com/copo888/channel_app/tarspay/internal/payutils"
	"github.com/copo888/channel_app/tarspay/internal/service"
	"github.com/copo888/channel_app/tarspay/internal/svc"
	"github.com/copo888/channel_app/tarspay/internal/types"
...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	data := struct {
		...
		CustomerContact string `json:"customerContact, optional"`
	...
	sign := payutils.SortAndSignFromObj(data, channel.MerKey, "/api/pay/unifiedOrder", strconv.FormatInt(unixTimestampMillis, 10), l.ctx)
