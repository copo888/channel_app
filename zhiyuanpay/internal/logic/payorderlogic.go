...
func (l *PayOrderLogic) PayOrder(req *types.PayOrderRequest) (resp *types.PayOrderResponse, err error) {
	...
	transactionAmountF := utils.FloatMul(req.TransactionAmount, "100", 0)
	transactionAmountS := fmt.Sprintf("%.0f", transactionAmountF) // s == "123.456000"
	...
	resp = &types.PayOrderResponse{
		PayPageType:    "url",
		PayPageInfo:    channelResp.Data.Cashier,
		ChannelOrderNo: "",
	}
