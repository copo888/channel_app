...
import (
	...
	"github.com/copo888/channel_app/zhiyuanpay/internal/logic"
...
func ProxyPayCheckHandler(ctx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {

		span := trace.SpanFromContext(r.Context())
		defer span.End()

		var req types.ProxyPayCheckRequest
		...
		l := logic.NewProxyPayCheckLogic(r.Context(), ctx)
		resp, err := l.ProxyPayCheck(&req)
		if err != nil {
