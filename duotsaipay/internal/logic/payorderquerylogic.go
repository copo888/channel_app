...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	...
	//	data.Set("orderno", req.ChannelOrderNo)
	//}
	...
	// 請求渠道
	logx.WithContext(l.ctx).Infof("支付查詢请求地址:%s,支付查询請求參數:%+v", channel.PayQueryUrl, data)
	...
	channelResp := struct {
		...
		State   int     `json:"odstate,optional"` //(代付订单：0处理中，1成功，2失败)  (充值订单：0处理中，1成功)
