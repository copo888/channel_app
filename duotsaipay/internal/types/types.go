...
type ProxyPayCallBackRequest struct {
	...
	Status       string `form:"orderstatus, optional"`
	Bankcardno   string `form:"bankcardno, optional"`
	Amount       string `form:"amount, optional"`
	Bankcardname string `form:"bankcardname, optional"`
	Bankname     string `form:"bankname, optional"`
	Withdrawtime string `form:"withdrawtime, optional"`
...
type PayCallBackRequest struct {
	...
	Sign    string `form:"sign, optional"`
	Time    string `form:"paytime, optional"`
	Msg     string `form:"msg, optional"`
	Attach  string `form:"attach, optional"`
}
