...
func (l *PayOrderQueryLogic) PayOrderQuery(req *types.PayOrderQueryRequest) (resp *types.PayOrderQueryResponse, err error) {
	auth := "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjAsInBsYXRmb3JtSWQiOjgsImFnZW50SWQiOjAsInZlcnNpb24iOjEsInBheW1lbnRJZCI6MCwiaWF0IjoxNjcyMTM3MzkxfQ.jlggWAGCOsaHJ_66AgSyrZiAxBLjmVbmkgaEmWVDogw"
